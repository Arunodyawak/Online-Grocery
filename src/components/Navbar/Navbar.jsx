            ...
            <nav className='max-w-[1400px] mx-auto md:h-[14vh] h-[12vh] px-10 flex justify-between items-center'>
                ...
                <div className='flex items-center gap-x-5'>
                 ...
                 {/* Mobile menu */}
                  ...
                  <ul className={`flex flex-col gap-y-12 bg-orange-400/15 backdrop-blur-xl shadow-xl rounded-xl p-10 items-center gap-x-15 md:hidden absolute top-30 -left-full transform-translate-x-1/2 transition-all duration-500 ${showMenu ? 'left-1/2' : ""}`}>
                    <li>
                        <a href="#"className='font-semibold tracking-wider  text-orange-500'>Home</a>
                    </li>
                     <li>
